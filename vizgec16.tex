...
also becomes a call to action, where volunteers can operate parts of the 
evolutionary algorithm itself thus becoming as a community, even more, an integral part of the
...
% A reference?
% Sentence expanded and phrase added - JJ
...
% this issue is explained to far away, but I guess is ok
...
% so that he is adding or maybe remove it like:
%The user can also load the webpage in several browsers or
%browser tabs thus adding more computing power and seeing how the 
...
% To reach this goal other aspects of the design must also be 
% addressed in order to improve the overall usabilty of the system.
